...
import vf.sudoku.model.solve.SolvableGroupType.{Column, Row}
import utopia.paradigm.enumeration.Axis.{X, Y}
import utopia.paradigm.enumeration.Axis2D
import vf.sudoku.model.solve.{Solvable, SolvableGroupType}
import vf.sudoku.model.solve.SolvableGroupType.{Column, Row}
 ...
 */
case class Slot(position: Coordinate, gridIndex: Int, number: Option[Int] = None,
				cantBe: Set[Int] = Set(), mustBe: Set[Int] = Set(),
				halfPlaceFor: Map[SolvableGroupType, Set[Int]] = Map())
	extends Solvable
{
	// ATTRIBUTES	--------------------
